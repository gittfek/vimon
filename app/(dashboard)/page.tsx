    ...
    <main className="bg-background text-foreground">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:grid lg:grid-cols-12 lg:gap-8 items-center">
            <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
              ...
              <div className="mt-8 sm:max-w-lg sm:mx-auto sm:text-center lg:text-left lg:mx-0">
                <Button size="lg" variant="outline" className="text-lg rounded-full text-primary">
                  Skapa konto
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="lg:grid lg:grid-cols-3 lg:gap-8">
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-lg font-medium mb-2">Enkel beställning</h3>
            ...
            <div className="flex flex-col items-center text-center mt-10 lg:mt-0">
              ...
              <h3 className="text-lg font-medium mb-2">Smidiga betalningar</h3>
              <p className="text-muted-foreground">
            ...
            <div className="flex flex-col items-center text-center mt-10 lg:mt-0">
              ...
              <h3 className="text-lg font-medium mb-2">Följ ditt projekt</h3>
              <p className="text-muted-foreground">
      ...
      <section className="py-16 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Button size="lg" className="text-lg rounded-full text-white bg-accent hover:bg-accent/90">
            Skapa konto
          </Button>
        </div>
      </section>
